...
urlpatterns = [
    ...
    path('flightServices/saveR/',views.save_reservation),
    path('api-token-auth/',obtain_auth_token,name="api-token-auth")  # for token confihure obtain_auth-token comparsary
]
